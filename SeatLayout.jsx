...
const SeatLayout = () => {
  ...
  return (
    <div key={row} className="flex flex-wrap gap-2 mt-2">
  ...
  return show ? (
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-10 md:pt-20">
      {/* Available Timings */}
      <div className="w-60 bg-primary/10 border border-primary/20 rounded-lg py-10 h-max md:sticky md:top-10">
      ...
      {/* Seat Layout */}
      <div className='relative flex-1 flex flex-col items-center max-md:md:mt-16'>
